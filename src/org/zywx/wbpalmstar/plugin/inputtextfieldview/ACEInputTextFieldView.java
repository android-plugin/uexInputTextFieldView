...
public class ACEInputTextFieldView extends LinearLayout implements
    ...
    public ACEInputTextFieldView(Context context, JSONObject params,
            EUExInputTextFieldView uexBaseObj) {
        super(context);
        ...
        mLayoutTransition.addTransitionListener(new TransitionListener() {
            ...
            public void endTransition(LayoutTransition transition,
                ...
                if (view.getId() == CRes.plugin_inputtextfieldview_parent_layout
                    ...
                    // Parent view height change ,so input and pager show
                    // together.
                    goScroll(0);
    ...
    private class EmotjiconsPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View layout = ((Activity) getContext()).getLayoutInflater()
                    .inflate(CRes.plugin_inputtextfieldview_emojicons_grid,
                            null);
            ...
            /*
             * if (keyBoardHeight != 0) { grid.setVerticalSpacing((int)
             * (keyBoardHeight / 25 * 2));
    ...
    public class EmojiconsGridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View layout = ((Activity) getContext()).getLayoutInflater()
                    .inflate(CRes.plugin_inputtextfieldview_emojicons_item,
                            null);
